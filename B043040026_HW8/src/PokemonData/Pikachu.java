...
public class Pikachu extends Pokemon {
    ...
    public Pikachu() {
        this.Level = 40;
        this.Fluctuation = 40;
        this.CorrectHeight = 40;
        this.CorrectWeight = 4000;
        this.Name = "Pikachu";
        ...
        this.Fluctuation = random.nextInt(this.Fluctuation + 1);//0~40
        if (addORsub == 0) {
        ...
        //set Height
        addORsub = random.nextInt(1);
        this.CorrectHeight = random.nextInt(this.CorrectHeight + 1);//0~40
        if (addORsub == 0) {
        ...
        //set Weight
        addORsub = random.nextInt(1);
        this.CorrectWeight = random.nextInt(this.CorrectWeight + 1);//0~4000
        if (addORsub == 0) {
